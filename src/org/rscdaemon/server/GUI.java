...
public class GUI extends JPanel {
	...
	private void button1ActionPerformed(ActionEvent e) {
		...
		try {
			...
			Logger.print("TestServer Starting Up.", 3);
...
//Label44
	...
	public static String readValue(String user, String key) {
		try {
			File f = new File("players/" + user.toLowerCase() + ".cfg");
			Properties pr = new Properties();
	...
	private void initComponents() {
		...
		setBorder(new javax.swing.border.CompoundBorder(
				new javax.swing.border.TitledBorder(new javax.swing.border.EmptyBorder(0, 0, 0, 0),
						...
						label6.setText("TestServer v" + (double)GameVars.projectVersion);
						...
						label11.setText("TestServer Created by Admin");
						label11.setFont(new Font("Tahoma", Font.BOLD, 16));

						label12.setText("to Report Bugs or Suggestion, visit localhost: ");
						label12.setFont(new Font("Tahoma", Font.PLAIN, 14));

						label13.setText("Based off RuneScape by JaGeX");
						...
						JFrame frame = new JFrame("TestServer v" + (double)GameVars.projectVersion + " Control Panel");
